...
// Add returns the sum of two angles, wrapped to 1 circle.
func (a Angle) Add(b Angle) Angle { return Angle(a.Rad() + b.Rad()).Mod1() }

// Subtract returns the difference of two angles, wrapped to 1 circle.
func (a Angle) Subtract(b Angle) Angle { return Angle(a.Rad() - b.Rad()).Mod1() }

// Abs returns the absolute value of an Angle.
func (a Angle) Abs() Angle { return Angle(math.Abs(a.Rad())) }
...
// LessThan returns true if the angle used is less than the angle passed. Otherwise false.
func (a Angle) LessThan(b Angle) bool { return a.Rad() < b.Rad() }

// GreaterThan returns true if the angle used is more than the angle passed. Otherwise false.
func (a Angle) GreaterThan(b Angle) bool { return a.Rad() > b.Rad() }

// LessThanOrEqual returns true if the angle used is less than or equal to the angle passed. Otherwise false.
func (a Angle) LessThanOrEqual(b Angle) bool { return a.Rad() <= b.Rad() }

// GreaterThanOrEqual returns true if the angle used is more than or equal to the angle passed. Otherwise false.
func (a Angle) GreaterThanOrEqual(b Angle) bool { return a.Rad() >= b.Rad() }
