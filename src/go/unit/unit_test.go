...
func TestAngleAdd(t *testing.T) {
	expected := unit.Angle(0.)
	got := unit.AngleFromDeg(359).Add(unit.AngleFromDeg(1))
	if got.Deg() != expected.Deg() {
		t.Errorf("TestAngleAdd: expected %v to be %v", got, expected)
	}
}

func TestAngleSubtract(t *testing.T) {
	expected := unit.Angle(0.)
	got := unit.AngleFromDeg(1).Subtract(unit.AngleFromDeg(1))
	if got.Deg() != expected.Deg() {
		t.Errorf("TestAngleAdd: expected %v to be %v", got, expected)
	}
}
...
func TestAngleAbs(t *testing.T) {
	expected := unit.AngleFromDeg(1.)
	got := unit.AngleFromDeg(-1).Abs()
	if got.Deg() != expected.Deg() {
		t.Errorf("TestAngleAdd: expected %v to be %v", got, expected)
	}
}
...
func TestAngleLessThan(t *testing.T) {
	a := unit.AngleFromDeg(1)
	b := unit.AngleFromDeg(2)
	expected := true
	got := a.LessThan(b)
	if got != expected {
		t.Errorf("TestAngleLessThan: %v expected to be %v", got, expected)
	}
}

func TestAngleGreaterThan(t *testing.T) {
	a := unit.AngleFromDeg(2)
	b := unit.AngleFromDeg(1)
	expected := true
	got := a.GreaterThan(b)
	if got != expected {
		t.Errorf("TestAngleLessThan: %v expected to be %v", got, expected)
...
func TestAngleLessThanOrEqual(t *testing.T) {
	a := unit.AngleFromDeg(1)
	b := unit.AngleFromDeg(2)
	expected := true
	got := a.LessThanOrEqual(b)
	if got != expected {
		t.Errorf("TestAngleLessThan: %v expected to be %v", got, expected)
	}
	a = b
...
func TestAngleGreaterThanOrEqual(t *testing.T) {
	a := unit.AngleFromDeg(2)
	b := unit.AngleFromDeg(1)
	expected := true
	got := a.GreaterThanOrEqual(b)
	if got != expected {
		t.Errorf("TestAngleLessThan: %v expected to be %v", got, expected)
	}
	a = b
